...
import { TransferOpenMessageEntity } from "@/schema/open-message.ts";
import { useSuspenseQuery } from "@tanstack/react-query";

type TransferMessageProps = OpenMessageProps<TransferOpenMessageEntity>;
...
function TransferMessageDefault({
	message,
	...props
...
function TransferMessageAbstract({
	message,
	...props
}: Omit<TransferMessageProps, "variant">) {
	return (
